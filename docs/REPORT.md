...
│   ├── admin-users.js
│   ├── admin-settings.js
│   ├── admin-reports.js     — аналитика + CSV-экспорт + страница рынка
...
| `/admin/market`, `/admin/market/api/data` | `requireAuth` + `requirePermission('admin:reports')` | [routes/admin-reports.js](../routes/admin-reports.js) |
